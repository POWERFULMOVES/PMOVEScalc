...
const Home = () => {
  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      if (!customPaymentAmount && response.data.payment_amount !== undefined && response.data.payment_amount !== null) {
      ...
      <CardContent>
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p>{formatCurrency(result.payment_amount + parseFloat(additionalPrincipal))}</p>
          </div>
          {creditInsurance && (
            <>
              <div>
              ...
              <AccordionItem value="loan-input">
                ...
                <AccordionContent>
                  <div className="space-y-6">
                    ...
                    {renderInputField('Days method', daysMethod, (value) => { setDaysMethod(value); handleCalculate(); }, 'Select days method', 'text', ['Actual', '30 Day Month'])}
                    {renderInputField('Year basis', yearBasis, (value) => { setYearBasis(value); handleCalculate(); }, 'Select the year basis for interest calculations', 'text', ['360', '365', '366'])}
